...
$query = "UPDATE ass SET ps='".$ps."',subbyi='".$subbyi."',duedt='".$duedt."',maxmks='".$maxmks."',wtge='".$wtge."',avgmks='".$avgmks."',avgdifi='".$avgdifi."',avgdifs='".$avgdifs."' WHERE cid='".$cid."' AND semid='".$semid."' AND ano='".$ano."' ;";
echo $query;
